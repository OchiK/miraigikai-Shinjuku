  ...
  return (
    <>
      <div className="fixed bottom-0 left-0 right-0 z-50">
        <div className="max-w-[700px] mx-auto bg-card">
          ...
          <div className="flex items-stretch">
            ...
            {showReaction && (
              <Button
                ...
                disabled={isPending}
                className="flex-1 flex items-center justify-center gap-2 h-auto py-5 rounded-none hover:bg-transparent active:bg-neutral-200"
              >
                <Lightbulb
                  size={20}
                ...
                <span
                  className={`text-[15px] font-bold transition-colors ${
                    isActive ? "text-status-rejected" : "text-mirai-text"
                  }`}
                >
                  参考になる
                </span>
            ...
            {showShare && (
              <>
                {/* セパレーター */}
                {showReaction && (
                  <div className="w-px self-center h-6 bg-neutral-400 shrink-0" />
                )}
                ...
                <Button
                  ...
                  className="flex-1 flex items-center justify-center gap-2 h-auto py-5 rounded-none hover:bg-transparent active:bg-neutral-200"
                >
                  <Upload size={20} className="text-mirai-text" />
