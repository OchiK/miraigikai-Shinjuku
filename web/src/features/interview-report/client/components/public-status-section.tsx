  ...
  return (
    <>
      <div className="flex flex-col items-center gap-2">
        {isPublic ? (
          <span className="inline-flex items-center gap-1 bg-sage-200 text-sage-700 text-sm font-bold px-4 py-1.5 rounded-full">
            公開
          </span>
        ) : (
          <span className="inline-flex items-center gap-1 bg-neutral-200 text-mirai-text-muted text-sm font-bold px-4 py-1.5 rounded-full">
            非公開
          </span>
        )}
        <Button
          ...
          className={`text-sm ${isPublic ? "text-mirai-text-muted" : "text-mirai-accent-text"}`}
        >
