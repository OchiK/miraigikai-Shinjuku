...
export function ExpertRegistrationBanner({
  ...
  return (
    <div className="bg-card rounded-2xl border border-primary p-6 flex flex-col gap-6">
      <div className="flex flex-col gap-4">
        ...
        <div className="flex flex-col gap-2.5">
          ...
          <p className="text-[15px] text-mirai-text">
            現場の知見を深めるため、登録をいただいた方には、今後運営者から追加のインタビューをお願いする場合があります。
          </p>
        </div>
      </div>
