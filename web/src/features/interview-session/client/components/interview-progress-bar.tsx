...
export function InterviewProgressBar({
  ...
  return (
    <div className="rounded-[18px] bg-card">
      {(currentTopic || remainingMinutes != null) && (
        <div className="mb-3 flex items-center gap-2">
          <div className="flex min-w-0 flex-1 items-center gap-2">
            {currentTopic && (
              <div className="inline-flex max-w-full rounded-full bg-mirai-tag px-4 py-0.5">
      ...
      <Progress
        value={percentage}
        className="h-[7px] rounded-full bg-neutral-300 [&>[data-slot=progress-indicator]]:bg-primary"
      />
    </div>
  );
}
