...
- [x] council members Phase 7-D: 議員本人のXアカウント導線（#86）
- [ ] minutes
- [ ] speeches
- [ ] committees
- [ ] budget explorer
...
2026-09-26: 議員本人の公式Xアカウント表示（Phase 7-D / BACKLOG P7-3）を実装・マージした（#86）。本人確認が取れた23名のアカウントをシード化し、`council_members.x_url` および本番インポーター拡張、議員詳細ページへの安全でアクセシブルな導線を追加。ウェブサイトURLは公式名簿掲載のもののみを維持。
