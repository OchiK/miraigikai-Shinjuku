...
- [x] language switcher
- [x] fallback
- [ ] 翻訳・ルビ手動確認・編集機能（Admin対照レビュー、stale差分表示、ルビ誤読補正辞書）
...
2026-09-23: 翻訳およびルビの手動確認・編集機能（Admin対照レビュー、stale差分表示、公開承認、ルビ誤読補正・辞書）の要件定義書を作成した（`docs/20260923_1650_翻訳およびルビ手動確認編集機能_要件定義.md`）。
